	...
	return (
		<div style={pageStyle}>
			...
			<div style={{
				...
				<ExampleLink href='?config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsImFpcnRhYmxlLW1jcC1zZXJ2ZXIiXSwiZW52Ijp7IkFJUlRBQkxFX0FQSV9LRVkiOiJwYXQxMjMuYWJjMTIzIn0sIm5hbWUiOiJhaXJ0YWJsZSJ9' code='?config=eyJjb21tYW5kIjoibnB4Ii4uLg' description='Stdio server (base64 JSON)' />
				<ExampleLink href='?config=' code='?config=eyJuYW1lIjoiaW8uZ2l0aHViLi4uLg' description='MCP registry server.json (base64 JSON)' />
			</div>
			...
			<div style={{
				...
				<code style={{color: 'var(--fg)'}}>?config=</code> &mdash; base64-encoded JSON for stdio or <a href='https://registry.modelcontextprotocol.io/' style={{color: 'var(--fg)'}}>server.json</a> configs
			</div>
